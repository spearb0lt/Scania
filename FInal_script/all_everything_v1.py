...
for epoch in range(1, NUM_EPOCHS+1):
    ...
    for x_cat, x_ts, y in train_loader:
        ...
        # dp_sgd_privacy(sample_rate, sigma, epoch, DELTA, ALPHAS, verbose=True)
        elif dp=="none":
            optimizer.zero_grad()
            loss = criterion(model(x_cat, x_ts), y)
            loss.backward()
...
# Train MSE: 262.9946 | Val MSE: 290.9218 | σ=0.600 | C=1.000
# Time: 0hrs. 2min. 43sec.
# Train MSE: 332.8733 | Val MSE: 290.9218 | σ=0.600 | C=1.000
# Time: 0hrs. 2min. 43sec.
# Model saved with val loss: 290.9218096118406

# Epoch 02 →

# Train MSE: 171.2954 | Val MSE: 193.3068 | σ=0.400 | C=1.000
# Time: 0hrs. 2min. 45sec.
# Train MSE: 229.0448 | Val MSE: 193.3068 | σ=0.400 | C=1.000
# Time: 0hrs. 2min. 45sec.
# Train MSE: 332.8733 | Val MSE: 290.9218 | σ=0.600 | C=1.000
# Time: 0hrs. 2min. 43sec.
# Model saved with val loss: 290.9218096118406
# Model saved with val loss: 193.30681481495967
# DP-SGD with
#         sampling rate = 4.88%,
