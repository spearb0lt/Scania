...
# sample_rate=0 # Batchsize/datasetsize
...
# # Targeted delta (default: 1e-5)
# delta = 1e-5

# # "List of alpha values (alpha orders of Renyi-DP evaluation). A default list is provided. Else, space separated numbers. E.g., -a 10 100"
# alphas=[1 + x / 10.0 for x in range(1, 100)] + list(range(12, 64))

# value = compute_dp_sgd_privacy(
#         sample_rate=sample_rate,
#         noise_multiplier=noise_multiplier,
#         epochs=epochs,
#         delta=delta,
